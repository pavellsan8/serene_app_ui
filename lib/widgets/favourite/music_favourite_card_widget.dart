...
class MusicFavouriteGridWidget extends StatelessWidget {
  final List<Music> musics;
  final Function(Music) onMusicTap;

  const MusicFavouriteGridWidget({
    Key? key,
...
class MusicFavouriteShimmerGridWidget extends StatelessWidget {
  const MusicFavouriteShimmerGridWidget({super.key});
